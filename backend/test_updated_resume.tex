...
\section{Experience}
  \CVSubHeadingListStart
    \CVSubheading
      ...
      \CVItemListEnd
    \CVSubheading
      {Junior Developer}{2021 -- 2022}
      {Tech Innovations}{}  
      \CVItemListStart
        \CVItem{Assisted in developing mobile applications using Java and Kotlin.}
        \CVItem{Collaborated with design team to create user-friendly interfaces.}
      \CVItemListEnd
  \CVSubHeadingListEnd
